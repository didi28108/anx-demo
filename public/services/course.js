...
myApp.service('CourseService', function($q, $http){
  ...
  var addSubcategory = function (data) {
    return $q(function(resolve, reject) {
      var req = {
        method  : 'POST',
        url     : '/api/addCourseSubcategory',
        data: {
          subcategory: data
        }
      }
  ...
  var editSubcategory = function (data) {
    return $q(function(resolve, reject) {
      var req = {
        method  : 'POST',
        url     : '/api/editCourseSubcategory',
        data: {
          subcategory: data
        }
      }
  ...
  var removeSubcategory = function (data) {
    return $q(function(resolve, reject) {
      var req = {
        method  : 'POST',
        url     : '/api/removeCourseSubcategory',
        data: {
          subcategory: data
        }
      }
